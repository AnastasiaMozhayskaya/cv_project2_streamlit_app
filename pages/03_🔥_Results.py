...
st.text('Тренировочный сет - 982 размеченных изображений')
st.text('Валидационный сет - 291 размеченных изображений')
st.text('Тестовый сет - 159 размеченных изображения')
